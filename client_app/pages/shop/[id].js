            ...
            <div className="container">
                ...
                <div className="mb-xl-5 mb-3">
                    <div className="row">
                        <div className="col-md-5 mb-4 mb-md-0">
                            <div id="sliderSyncingNav" className="js-slick-carousel u-slick mb-2"
                                data-infinite="true"
                                ...
                                <div className="js-slide">
                                    <img className="img-fluid" src="/assets/img/720X660/img1.jpg" alt="Image Description" />
                                </div>
                                <div className="js-slide">
                                    <img className="img-fluid" src="/assets/img/720X660/img2.jpg" alt="Image Description" />
                                </div>
                                <div className="js-slide">
                                    <img className="img-fluid" src="/assets/img/720X660/img3.jpg" alt="Image Description" />
                                </div>
                                <div className="js-slide">
                                    <img className="img-fluid" src="/assets/img/720X660/img4.jpg" alt="Image Description" />
                                </div>
                                <div className="js-slide">
                                    <img className="img-fluid" src="/assets/img/720X660/img5.jpg" alt="Image Description" />
                                </div>
                            </div>
                        ...
                        <div className="col-md-7 mb-md-6 mb-lg-0">
                            <div className="mb-2">
                                <div className="border-bottom mb-3 pb-md-1 pb-3">
                                    ...
                                    <div className="text-gray-9 font-size-14">SKU: <span className="text-gray-9 font-weight-bold">FW511948218</span></div>
                                    <div className="text-gray-9 font-size-14 ml-2">Availability: <span className="text-gray-9 font-weight-bold">26 in stock</span></div>
                                    <a href="#" className="text-gray-9 font-size-14 font-weight-bold ml-md-2 mt-1"><i className="ec ec-favorites mr-1 text-gray-9 font-size-15"></i> Wishlist</a>
                                    <a href="#" className="text-gray-9 font-size-14 font-weight-bold ml-md-2 ml-2 mt-1"><i className="ec ec-compare mr-1 text-gray-9 font-size-15"></i> Compare</a>
                                ...
                                <div className="mb-2">
                                    <div className="d-flex align-items-baseline">
                                        <ins className="font-size-32 text-decoration-none">$1,999.00</ins>
                                ...
                                <div className="row no-gutters">
                                    <div className="col mb-6 mb-md-0">
                                        ...
                                        <div className="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                            <input className="form-check-input" type="checkbox" value="" id="inlineCheckbox1" checked disabled />
                                            <label className="form-check-label mb-1" for="inlineCheckbox1">
                                        ...
                                        <div className="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                            <input className="form-check-input" type="checkbox" id="inlineCheckbox2" value="option1" checked />
                                            <label className="form-check-label mb-1 text-blue" for="inlineCheckbox2">
                                        ...
                                        <div className="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                                            <input className="form-check-input" type="checkbox" id="inlineCheckbox3" value="option2" checked />
                                            <label className="form-check-label mb-1 text-blue" for="inlineCheckbox3">
                                ...
                                <div className="row mb-8">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <form className="js-validate">
                                            ...
                                            <div className="js-form-message form-group mb-3 row">
                                                <div className="col-md-4 col-lg-3">
                                                    <label for="emailAddress" className="form-label">Email <span className="text-danger">*</span></label>
                                                </div>
                                                <div className="col-md-8 col-lg-9">
                ...
                <div className="mb-6">
                    <div className="d-flex justify-content-between align-items-center border-bottom border-color-1 flex-lg-nowrap flex-wrap mb-4">
                        <h3 className="section-title mb-0 pb-2 font-size-22">Related products</h3>
                    </div>
