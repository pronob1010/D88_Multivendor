...
export default function HeaderAll() {
    ...
    let vurl = '/branch/' + router.query.slug;

    let vmenu;

    // if (typeof(vendor_menu) != "undefined") {
    //     console.log(vurl);


    if (router.pathname == '/branch/[slug]') {
    ...
    return (
        ...
        <header id="header" className="u-header u-header-left-aligned-nav">
            <div className="u-header__section">
                {/* <!--Topbar --> */}
                <div className="u-header-topbar py-2 d-none d-xl-block bg-primary border-bottom-0">
                    <div className="container">
                        <div className="d-flex align-items-center">
                            <div className="topbar-left">
                                <a href="#" className="text-gray-70 font-size-13 u-header-topbar__nav-link">Welcome to Worldwide Electronics Store</a>
                            </div>
                            <div className="topbar-right ml-auto">
                                <ul className="list-inline mb-0">
                                    ...
                                    <li className="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border full-bg">
                                        <a href="#" className="u-header-topbar__nav-link"><i className="ec ec-transport mr-1"></i> Track Your Order</a>
                                    </li>
                                    <li className="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border full-bg u-header-topbar__nav-item-no-border u-header-topbar__nav-item-border-single">
                                        <div className="d-flex align-items-center">
                                            {/* <!--Language --> */}
                ...
                <div className="py-2 py-xl-5 bg-primary">
                            ...
                            <div className="col d-none d-xl-block">
                                <form className="js-focus-state">
                                    ...
                                    <div className="input-group">
                                        <input type="email" className="form-control py-2 pl-5 font-size-15 border-right-0 height-42 border-width-0 rounded-left-pill border-primary" name="email" id="searchproduct-item" placeholder="Search for Products" aria-label="Search for Products" aria-describedby="searchProduct1" required />
                                        <div className="input-group-append">
                                            {/* <!--Select --> */}
                                            <select className="js-select selectpicker dropdown-select custom-search-categories-select bg-white"
                                            ...
                                            {/* <!--End Select --> */}
                                            <button className="btn btn-dark height-42 py-2 px-3 rounded-right-pill" type="button" id="searchProduct1">
                                                <span className="ec ec-search font-size-20"></span>
                                            </button>
                                        </div>
                                    </div>
                                </form>
                ...
                {/* <!--Primary-menu-wide --> */}
                <div className="d-none d-xl-block bg-primary border-color-2">
                    <div className="container">
                                ...
                                <div id="navBar" className="collapse navbar-collapse u-header__navbar-collapse">
                                    <ul className="navbar-nav u-header__navbar-nav">
                                                    ...
                                                    <div className="col-md-8">
                                                        <div className="row">
                                                            <div className="col-md-3">
                                                                ...
                                                                <ul className="u-header__sub-menu-nav-group">
                                                                    <li><a href="#" className="nav-link u-header__sub-menu-nav-link">For iPhone X<br></br> </a></li>
                                                            ...
                                                            <div className="col-md-3">
                                                                ...
                                                                <ul className="u-header__sub-menu-nav-group">
                                                                    ...
                                                                    <li><a href="#" className="nav-link u-header__sub-menu-nav-link">Panasonic<br></br> </a></li>
                                                    ...
                                                    <div className="col-md-8">
                                                        <div className="row">
                                                            <div className="col-md-3">
                                                                ...
                                                                <span className="u-header__sub-menu-title">Shop By Brand</span>
                                                                <ul className="u-header__sub-menu-nav-group">
                                                                    <li><a href="#" className="nav-link u-header__sub-menu-nav-link">Apple<br></br> </a></li>
                                                            ...
                                                            <div className="col-md-3">
                                                                ...
                                                                <ul className="u-header__sub-menu-nav-group">
                                                                    ...
                                                                    <li><a href="#" className="nav-link u-header__sub-menu-nav-link">Keyboards<br></br> </a></li>
                                                            ...
                                                            <div className="col-md-3">
                                                                ...
                                                                <ul className="u-header__sub-menu-nav-group">
                                                                    <li><a href="#" className="nav-link u-header__sub-menu-nav-link">Intel Core i9-7980XE<br></br> </a></li>
                                        ...
                                        <li className="nav-item hs-has-mega-menu u-header__nav-item"
                                            ...
                                            {/* <!--GPS & Car - Mega Menu --> */}
                                            <div className="hs-mega-menu w-100 u-header__sub-menu" aria-labelledby="GPSCarMegaMenu" style={{minWidth: '330px'}}>
                                                <div className="row u-header__mega-menu-wrapper">
                                                    <div className="col-md-8">
                                                        <div className="row">
                                                            <div className="col-md-3">
                                        ...
                                        {/* <!--End Movies & Games --> */}
                                        <li className="nav-item hs-has-mega-menu u-header__nav-item">
                                            <a id="homeMegaMenu" className="nav-link u-header__nav-link" href="/faq" aria-haspopup="true" aria-expanded="false">FAQs</a>
                                        </li>
                                        <li className="nav-item hs-has-mega-menu u-header__nav-item">
                                            <a id="homeMegaMenu" className="nav-link u-header__nav-link" href="/aboutus" aria-haspopup="true" aria-expanded="false">About Us</a>
                                        </li>
                                    </ul>
                                </div>
                                {/* <!--End Navigation --> */}
