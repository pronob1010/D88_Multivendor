...
export default function Shop({ productdata }) {
  ...
  let counter_loop = 0;
  let RegularShopCardList = datatest.map((item) => {
    counter_loop += 1;
    if (counter_loop <= count) return <ShopCard data={item} key={item.id} />;
  });
                ...
                <div className="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                  <div className="custom-control custom-checkbox">
                    <input
                      ...
                      id="brandAdidas"
                    />
                    <label className="custom-control-label" for="brandAdidas">
                      Adidas
                ...
                <div className="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                  <div className="custom-control custom-checkbox">
                    <input
                      ...
                      id="brandNike"
                    />
                    <label className="custom-control-label" for="brandNike">
                      Nike
                      <span className="text-gray-25 font-size-12 font-weight-normal">
                        {" "}
                        (56)
                ...
                <div className="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                  <div className="custom-control custom-checkbox">
                    <input
                      ...
                      id="brandTnf"
                    />
                    <label className="custom-control-label" for="brandTnf">
                      The North Face
                      <span className="text-gray-25 font-size-12 font-weight-normal">
                        {" "}
                        (56)
                  ...
                  <div className="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                    <div className="custom-control custom-checkbox">
                      <input
                        ...
                        id="brandGucci"
                      />
                      <label className="custom-control-label" for="brandGucci">
                        Gucci
                        <span className="text-gray-25 font-size-12 font-weight-normal">
                          {" "}
                          (56)
                  ...
                  <div className="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                    <div className="custom-control custom-checkbox">
                      <input
                        ...
                        id="brandMango"
                      />
                      <label className="custom-control-label" for="brandMango">
                        Mango
                        <span className="text-gray-25 font-size-12 font-weight-normal">
                          {" "}
                          (56)
                ...
                <div className="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                  <div className="custom-control custom-checkbox">
                    <input
                      ...
                      id="categoryShoes"
                    />
                    <label className="custom-control-label" for="categoryShoes">
                      Black Leather{" "}
                      <span className="text-gray-25 font-size-12 font-weight-normal">
                        {" "}
                        (56)
                ...
                <div className="form-group d-flex align-items-center justify-content-between mb-2 pb-1">
                  <div className="custom-control custom-checkbox">
                    <input
                      ...
                      id="categoryTops"
                    />
                    <label className="custom-control-label" for="categoryTops">
                      Gold{" "}
                      <span className="text-gray-25 font-size-12 font-weight-normal">
                        {" "}
                        (56)
          ...
          <div className="col-xl-9 col-wd-9gdot5">
            ...
            <div className="mb-6 d-none d-xl-block">
              <div className="position-relative">
                ...
                <div
                  className="js-slick-carousel u-slick position-static overflow-hidden u-slick-overflow-visble pb-4 pt-2 px-1"
            ...
            <div className="flex-center-between mb-3">
              ...
              <p className="font-size-14 text-gray-90 mb-0">
                Showing 1–{count} of {length_data} results
              </p>
            </div>
              ...
              <nav className="px-3 flex-horizontal-center text-gray-20 d-none d-xl-flex">
                <form method="post" className="min-width-50 mr-1">
                  <input
                    ...
                    value={Math.ceil(count / paginate_product)}
                  />
                </form>{" "}
                of {total_page}
              ...
              <ul className="pagination mb-0 pagination-shop justify-content-center justify-content-md-start">
                {count < length_data ? (
                  <button
                    onClick={() =>
                      setCount(
                        length_data - count >= paginate_product
                          ? count + paginate_product
                          : count + (length_data - count)
                      )
                    }
